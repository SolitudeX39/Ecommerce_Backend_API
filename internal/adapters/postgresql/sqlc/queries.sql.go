...
SELECT id, name, price_in_centers, quantity_in_stock, created_at FROM products WHERE id = $1
`
...
SELECT id, name, price_in_centers, quantity_in_stock, created_at FROM products
`
